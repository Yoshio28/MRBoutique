...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> j, String id) => Product(
        id: id,
...
class ProductsAdminProvider extends ChangeNotifier {
  static const _collection = 'productos_admin';
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      _products
        ..clear()
        ..addAll(snap.docs.map((d) => Product.fromMap(d.data(), d.id)));
    } catch (e) {
      print('ProductsAdminProvider._load → $e');
    } finally {
      _loading = false;
      notifyListeners();
    }
  ...
  Future<void> addProduct(Product p) async {
    try {
      ...
      _products.add(Product.fromMap(data, docRef.id));
      notifyListeners();
    } catch (e) {
      print('ProductsAdminProvider.addProduct → $e');
    }
  }
  ...
  Future<void> updateProduct(Product updated) async {
    try {
      ...
      print('ProductsAdminProvider.updateProduct → $e');
    }
  }
  ...
  Future<void> deleteProduct(String id) async {
    try {
      ...
      print('ProductsAdminProvider.deleteProduct → $e');
    }
  }
}
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(width: 8),
                    Text(
                        '${product.margin.toStringAsFixed(0)}% margen',
                        style: TextStyle(
