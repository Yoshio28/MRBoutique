...
class Employee {
  ...
  factory Employee.fromMap(Map<String, dynamic> j, String id) => Employee(
        id: id,
...
class EmployeesProvider extends ChangeNotifier {
  static const _collection = 'empleados_admin';
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      _employees
        ..clear()
        ..addAll(snap.docs.map((d) => Employee.fromMap(d.data(), d.id)));
    } catch (e) {
      print('EmployeesProvider._load → $e');
    } finally {
      _loading = false;
      notifyListeners();
    }
  ...
  Future<void> addEmployee(Employee emp) async {
    try {
      ...
      _employees.add(Employee.fromMap(data, docRef.id));
      notifyListeners();
    } catch (e) {
      print('EmployeesProvider.addEmployee → $e');
    }
  }
 
  Future<void> updateEmployee(Employee updated) async {
    try {
      await _db.collection(_collection).doc(updated.id).update(updated.toMap());
      ...
      print('EmployeesProvider.updateEmployee → $e');
    }
  }
  ...
  Future<void> toggleActive(String id) async {
    ...
    if (i == -1) return;
    final newValue = !_employees[i].isActive;
    try {
      await _db.collection(_collection).doc(id).update({'isActive': newValue});
      _employees[i].isActive = newValue;
      notifyListeners();
    } catch (e) {
      print('EmployeesProvider.toggleActive → $e');
    }
  }
  ...
  Future<void> deleteEmployee(String id) async {
    try {
      ...
      print('EmployeesProvider.deleteEmployee → $e');
    }
  }
}
                  ...
                  child: list.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (_, i) => _EmployeeCard(
                            ...
                            onToggle: () =>
                                provider.toggleActive(list[i].id),
                            onDelete: () async {
